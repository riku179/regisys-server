...
func NewAddItemsContext(ctx context.Context, service *goa.Service) (*AddItemsContext, error) {
	var err error
...
func NewDeleteItemsContext(ctx context.Context, service *goa.Service) (*DeleteItemsContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
...
func NewModifyItemsContext(ctx context.Context, service *goa.Service) (*ModifyItemsContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
...
func NewShowItemsContext(ctx context.Context, service *goa.Service) (*ShowItemsContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
