...
func MountItemsController(service *goa.Service, ctrl ItemsController) {
	...
	h = func(ctx context.Context, rw http.ResponseWriter, req *http.Request) error {
		...
		// Build the context
		rctx, err := NewAddItemsContext(ctx, req, service)
		if err != nil {
			return err
		}
		// Build the payload
	...
	h = func(ctx context.Context, rw http.ResponseWriter, req *http.Request) error {
		...
		// Build the context
		rctx, err := NewDeleteItemsContext(ctx, req, service)
		if err != nil {
			return err
		}
	...
	h = func(ctx context.Context, rw http.ResponseWriter, req *http.Request) error {
		...
		// Build the context
		rctx, err := NewModifyItemsContext(ctx, req, service)
		if err != nil {
			return err
		}
		// Build the payload
	...
	h = func(ctx context.Context, rw http.ResponseWriter, req *http.Request) error {
		...
		// Build the context
		rctx, err := NewShowItemsContext(ctx, req, service)
		if err != nil {
			return err
		}
...
func MountOrdersController(service *goa.Service, ctrl OrdersController) {
	...
	h = func(ctx context.Context, rw http.ResponseWriter, req *http.Request) error {
		...
		// Build the context
		rctx, err := NewAddOrdersContext(ctx, req, service)
		if err != nil {
			return err
		}
		// Build the payload
	...
	h = func(ctx context.Context, rw http.ResponseWriter, req *http.Request) error {
		...
		// Build the context
		rctx, err := NewDeleteOrdersContext(ctx, req, service)
		if err != nil {
			return err
		}
		return ctrl.Delete(rctx)
	...
	h = func(ctx context.Context, rw http.ResponseWriter, req *http.Request) error {
		...
		// Build the context
		rctx, err := NewShowOrdersContext(ctx, req, service)
		if err != nil {
			return err
		}
		return ctrl.Show(rctx)
...
func MountUserController(service *goa.Service, ctrl UserController) {
	...
	h = func(ctx context.Context, rw http.ResponseWriter, req *http.Request) error {
		...
		// Build the context
		rctx, err := NewModifyUserContext(ctx, req, service)
		if err != nil {
			return err
		}
		// Build the payload
	...
	h = func(ctx context.Context, rw http.ResponseWriter, req *http.Request) error {
		...
		// Build the context
		rctx, err := NewShowListUserContext(ctx, req, service)
		if err != nil {
			return err
		}
