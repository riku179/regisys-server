...
func AddItemsNoContent(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.ItemsController, payload *app.AddGoodsPayload) http.ResponseWriter {
	...
	addCtx, err := app.NewAddItemsContext(goaCtx, service)
	if err != nil {
...
func DeleteItemsForbidden(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.ItemsController, id int) http.ResponseWriter {
	...
	goaCtx := goa.NewContext(goa.WithAction(ctx, "ItemsTest"), rw, req, prms)
	deleteCtx, err := app.NewDeleteItemsContext(goaCtx, service)
	if err != nil {
		panic("invalid test data " + err.Error()) // bug
	}
...
func ModifyItemsNoContent(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.ItemsController, id int, payload *app.ModifyGoodsPayload) http.ResponseWriter {
	...
	goaCtx := goa.NewContext(goa.WithAction(ctx, "ItemsTest"), rw, req, prms)
	modifyCtx, err := app.NewModifyItemsContext(goaCtx, service)
	if err != nil {
		panic("invalid test data " + err.Error()) // bug
	}
...
func ShowItemsNotFound(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.ItemsController, user *int) http.ResponseWriter {
	...
	goaCtx := goa.NewContext(goa.WithAction(ctx, "ItemsTest"), rw, req, prms)
	showCtx, err := app.NewShowItemsContext(goaCtx, service)
	if err != nil {
		panic("invalid test data " + err.Error()) // bug
	}
...
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func ShowItemsOK(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.ItemsController, user *int) (http.ResponseWriter, app.GoaExampleRegisysItemsCollection) {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
	...
	var mt app.GoaExampleRegisysItemsCollection
	if resp != nil {
		var ok bool
		mt, ok = resp.(app.GoaExampleRegisysItemsCollection)
		if !ok {
			t.Fatalf("invalid response media: got %+v, expected instance of app.GoaExampleRegisysItemsCollection", resp)
		}
		err = mt.Validate()
		if err != nil {
