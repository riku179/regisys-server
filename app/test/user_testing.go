...
func AddUserForbidden(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.UserController, payload *app.AddUserPayload) http.ResponseWriter {
	...
	addCtx, err := app.NewAddUserContext(goaCtx, req, service)
	if err != nil {
...
func ModifyUserForbidden(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.UserController, id int, payload *app.ModifyUserPayload) http.ResponseWriter {
	...
	goaCtx := goa.NewContext(goa.WithAction(ctx, "UserTest"), rw, req, prms)
	modifyCtx, err := app.NewModifyUserContext(goaCtx, req, service)
	if err != nil {
		panic("invalid test data " + err.Error()) // bug
	}
...
func ShowUserNotFound(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.UserController, id int) http.ResponseWriter {
	...
	goaCtx := goa.NewContext(goa.WithAction(ctx, "UserTest"), rw, req, prms)
	showCtx, err := app.NewShowUserContext(goaCtx, req, service)
	if err != nil {
		panic("invalid test data " + err.Error()) // bug
	}
...
func ShowListUserOK(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.UserController) (http.ResponseWriter, app.RegisysUserCollection) {
	...
	goaCtx := goa.NewContext(goa.WithAction(ctx, "UserTest"), rw, req, prms)
	showListCtx, err := app.NewShowListUserContext(goaCtx, req, service)
	if err != nil {
		panic("invalid test data " + err.Error()) // bug
	}
