...
// ModifyUserForbidden runs the method Modify of the given controller with the given parameters.
// It returns the response writer so it's possible to inspect the response headers.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func ModifyUserForbidden(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.UserController, id string, group *string) http.ResponseWriter {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
	...
	query := url.Values{}
	if group != nil {
		sliceVal := []string{*group}
		query["group"] = sliceVal
	}
	u := &url.URL{
...
// ModifyUserNoContent runs the method Modify of the given controller with the given parameters.
// It returns the response writer so it's possible to inspect the response headers.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func ModifyUserNoContent(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.UserController, id string, group *string) http.ResponseWriter {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
...
// ModifyUserNotFound runs the method Modify of the given controller with the given parameters.
// It returns the response writer so it's possible to inspect the response headers.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func ModifyUserNotFound(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.UserController, id string, group *string) http.ResponseWriter {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
