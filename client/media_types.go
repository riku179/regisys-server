...
// DecodeGoaExampleRegisysGoods decodes the GoaExampleRegisysGoods instance encoded in resp body.
func (c *Client) DecodeGoaExampleRegisysGoods(resp *http.Response) (*GoaExampleRegisysGoods, error) {
	var decoded GoaExampleRegisysGoods
	err := c.Decoder.Decode(&decoded, resp.Body, resp.Header.Get("Content-Type"))
	return &decoded, err
}
...
// DecodeGoaExampleRegisysGoodsCollection decodes the GoaExampleRegisysGoodsCollection instance encoded in resp body.
func (c *Client) DecodeGoaExampleRegisysGoodsCollection(resp *http.Response) (GoaExampleRegisysGoodsCollection, error) {
	var decoded GoaExampleRegisysGoodsCollection
	err := c.Decoder.Decode(&decoded, resp.Body, resp.Header.Get("Content-Type"))
	return decoded, err
}
